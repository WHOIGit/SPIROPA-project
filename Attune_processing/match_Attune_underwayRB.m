...
summarypath = 'D:\SPIROPA\20190511_RB1904\Attune\Summary\';
load([summarypath 'AttuneTable'])
t = strncmpi(AttuneTable.Filename,'SPIROPA_RB1904_Grazer', 21);
AttuneTable(find(t),:) = [];
t = strncmpi(AttuneTable.Filename,'FCB', 3);
AttuneTable(find(t),:) = [];

%uw = load('C:\work\SPIROPA\RB1904\UW\tsg_with_gps');
uw = load('\\10.48.13.229\survey\RB1904\gps_Gordon\tsg_with_gps');
...
run('\\10.48.13.229\survey\RB1904\Gordon_scripts\rb1904_transect_startime')
...
uw = load('\\10.48.13.229\survey\RB1904\gps_Gordon\flr_with_gps');
% uw = [];
% for day = 12:21
