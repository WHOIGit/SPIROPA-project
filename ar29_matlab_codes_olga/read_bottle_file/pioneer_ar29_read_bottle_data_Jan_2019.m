% pioneer_ar29_read_bottle_data_Jan_2019.m
...
%@@@@@@@@@@@@@@@@@@  FILE NAMES   @@@@@@@@@@@@@@@@@@@@
%@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
fname='ar29_bottle_data_Jan_2019';
...
eval(p);
% MATFILE variables:
% (1) numeric matrix "data", size: 1055x66;
...
%@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
group_list=strvcat('CTD casts info (cols 1:13)','CTD BTL data (cols 14:36)','POC, PP, IntProd (cols 37:49)','Nuts (cols 50:54)','Chl (cols 55:66)','CANCEL');
...
%**************************
leg_location=3;
if group_num==3 | group_num==5 % POC,PP,IntProd, Chl
    lowerDepth=300;
    leg_location=4;
else
    lowerDepth=800;
